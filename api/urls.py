...
router.register(r'asignacion_estudiante', viewsets.Asignacion_estudianteViewset)
router.register(r'eventos', viewsets.EventosViewset)
router.register(r'material_de_clase', viewsets.Materiales_de_claseViewset)
router.register(r'tareadocente', viewsets.TareaViewset)
router.register(r'tareaestudiante', viewsets.TareasestudianteViewset)
